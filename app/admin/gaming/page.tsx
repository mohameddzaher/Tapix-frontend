  ...
  if (!category) {
    return (
      <div className="space-y-6">
        <h1 className="text-2xl font-semibold text-dark-900">Gaming</h1>
        <Card padding="lg" className="text-center py-16">
          ...
          <p className="mt-2 text-dark-500 max-w-md mx-auto">
            The &quot;gaming&quot; category doesn&apos;t exist yet. Create it to start managing Gaming products.
          </p>
          ...
          <div className="mt-4 p-4 bg-beige-50 rounded-lg text-left max-w-sm mx-auto">
            ...
            <ol className="text-xs text-dark-500 space-y-1 list-decimal list-inside">
              <li>Create a category named &quot;Gaming&quot;</li>
              <li>Make sure the slug is &quot;gaming&quot;</li>
              <li>Add subcategories (Consoles, Controllers, Gaming Chairs, etc.)</li>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-dark-500 mt-1 text-sm">
            Manage the Gaming category, subcategories, and products
          </p>
        </div>
        <div className="flex flex-wrap gap-2">
          <Link href="/gaming" target="_blank">
        ...
        {subcategories.length === 0 ? (
          <div className="px-6 py-8 text-center">
            ...
            <p className="text-dark-400 text-xs mt-1">
              Add subcategories like &quot;Consoles, Controllers, Gaming Chairs, etc.
            </p>
            <Link href="/admin/categories/new">
